...
import { deleteLog, clearAllLogs } from "../../utils/logger";
...
const UserLogPage = () => {
  ...
  const handleDelete = (logId) => {
    ...
    // User confirmed deletion - use our logger service
            ...
            {filteredLogs.length === 0 ? (
              ...
              filteredLogs.map((log) => (
                <tr key={log.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{formatDate(log.loginTime)}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{formatDate(log.logoutTime)}</td>
